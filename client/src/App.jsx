...
const App = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center p-5 md:px-20">
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-[660px] h-full overflow-hidden">
        ...
        <div className="flex justify-end">
          <button
            className="bg-gradient-to-r from-teal-400 to-blue-500 hover:to-cyan-300 hover:from-blue-300 text-white p-3 rounded-lg font-semibold text-xl w-52 transition-all duration-300"
